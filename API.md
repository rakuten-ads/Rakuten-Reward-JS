...
| language                       | 'ja', 'en', 'zh-TW', 'zh-CN', 'ko-KR' | Optional  | 'ja'          | Language used in Mission Reward. If empty, we will use browser's language setting. Default is `ja`. Details please refer to [FAQ.md](./FAQ.md#how-many-languages-does-sdk-support) |
